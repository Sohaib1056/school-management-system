...
import { Box, Text, SimpleGrid, VStack, HStack, Table, Thead, Tbody, Tr, Th, Td, Badge, Button, Icon, useColorModeValue, Select, Checkbox, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, ModalFooter, useDisclosure, Input, FormControl, FormLabel, Divider, useToast } from '@chakra-ui/react';
  ...
  return (
    <Box pt={{ base:'130px', md:'80px', xl:'80px' }}>
      ...
      <SimpleGrid columns={{ base:1, md:3 }} spacing='12px' mb='16px'>
        <Card p='20px' bgGradient='linear(to-r, red.400, orange.400)' color='white'><VStack align='start' spacing={1}><Text fontSize='sm' opacity={0.9}>Pending Items</Text><Text fontSize='3xl' fontWeight='800'>{pending.length}</Text></VStack></Card>
        <Card p='20px' bgGradient='linear(to-r, blue.400, cyan.400)' color='white'><VStack align='start' spacing={1}><Text fontSize='sm' opacity={0.9}>Selected Total</Text><Text fontSize='3xl' fontWeight='800'>{formatCurrency(total)}</Text></VStack></Card>
        <Card p='20px' bgGradient='linear(to-r, green.400, teal.400)' color='white'><VStack align='start' spacing={1}><Text fontSize='sm' opacity={0.9}>Method</Text><Text fontSize='3xl' fontWeight='800'>{method==='card'? 'Card':'Wallet'}</Text></VStack></Card>
      </SimpleGrid>
